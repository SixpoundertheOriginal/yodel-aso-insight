...
import { TrafficSourceProvider } from "./context/TrafficSourceProvider"; // ✅ ADD THIS IMPORT
    ...
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        ...
        <BrowserRouter>
          <AuthProvider>
            <BigQueryAppProvider>
              {/* ✅ ADD: TrafficSourceProvider wrapper */}
              <TrafficSourceProvider clientList={['TUI']} enabled={true}>
                <AsoDataProvider>
                  <AppProvider>
                    <AsoAiHubProvider>
                      <WorkflowProvider>
              ...
              {/* ✅ END: TrafficSourceProvider wrapper */}
            </BigQueryAppProvider>
          </AuthProvider>
        </BrowserRouter>
      </TooltipProvider>
